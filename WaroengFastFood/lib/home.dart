...
class _HomeState extends State<Home> {
                ...
                Column(
                  children: List.generate(
                    ...
                    (index) => popularFoodCard(
                        ...
                        popularFoodList[index]['berat'],
                        popularFoodList[index]['bintang']),
                  ),
                ),
              ],
            ),
  ...
  Widget popularFoodCard(
      String imagePath, String name, String berat, String star) {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PrimaryText(
                          text: berat, size: 18, color: AppColors.lightGray),
                    ],
                  ),
                ),
                SizedBox(
